...
int main()
{
   DistanceTree tree(8);
   tree.Set(1, 1);
   assert(tree.CountFrom(1) == 1);

   tree.Set(2, 1);
   assert(tree.CountFrom(1) == 2);
   assert(tree.CountFrom(2) == 1);

   tree.Set(3, 1);
   assert(tree.CountFrom(1) == 3);
   assert(tree.CountFrom(2) == 2);
   assert(tree.CountFrom(3) == 1);
